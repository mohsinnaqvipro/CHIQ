...
const LoginForm: React.FC<LoginFormProps> = ({
  ...
  const responseFacebook = (response) => {
    console.log(response.accessToken, `"${response.accessToken}"`, `${response.accessToken}`);
    Axios.post("http://chiq.com.pk/api/social-login/", {provider:"facebook", access_token:`"${response.accessToken}"`}).then((res) => {
